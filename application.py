...
class Users(db.Model):
    ...
    first = db.Column(db.String(1024), nullable=False, default="No first name")
    last = db.Column(db.String(1024), nullable=False, default="No last name")
    caresof = db.Column(db.String(1024), nullable=True, default="No C/O")
    ...
    city = db.Column(db.String(1024), nullable=False, default="No city")
...
class Boxes(db.Model):
    ...
    width = db.Column(db.Integer, nullable=False, default=0)
    height = db.Column(db.Integer, nullable=False, default=0)
    weight_ne = db.Column(db.Integer, nullable=False, default=0)
    weight_ex = db.Column(db.Integer, nullable=False, default=0)
...
class Orders(db.Model):
    id = db.Column(db.Integer, primary_key=True, nullable=False, autoincrement=True, unique=True)
    user_id = db.Column(db.Integer, nullable=False)
    date = db.Column(db.String(1024), nullable=True)
    plants = db.Column(db.Text, nullable=True)
